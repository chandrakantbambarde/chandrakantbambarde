...
# About Me  
💡 I am a **Java Full Stack Developer (Fresher)** passionate about building **scalable backend systems and full-stack web applications**.  

☕ I specialize in **Core Java, Spring Boot, REST APIs, MySQL, and Hibernate/JPA**, with hands-on experience in building **real-world projects**.  

🌐 On the frontend, I work with **HTML, CSS, JavaScript**, focusing on clean UI and seamless backend integration.  

🛠️ I enjoy solving problems, writing **clean & maintainable code**, and continuously improving my skills through practice and projects.  

🌱 Currently learning **Advanced Spring Boot, System Design, Docker, and Microservices**, and preparing for **entry-level Full Stack Java Developer roles**.  
...
- 🛒 **Full Stack Java Web Application (CRUD)**  
- 🧾 **Student / Employee Management System**  
- 🗄️ **MySQL Database Design Projects**  
